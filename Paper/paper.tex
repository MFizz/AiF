...
Ein konkreter Ansatz um Maschinelles Lernen in unser Lösung einzubauen wäre Regret Minimization, der Agenten die Möglichkeit gibt aus der Vergangenheit zu lernen um ihren Bedauern in der Zukunft zu minimieren. Jedoch, um Regret Minimization in unser Implementierung einzubauen, müssen mehreren Änderungen im Algorithmus vorgenommen werden. Anfangs muss die Nutzenfunktion geändert werden, sodass sie frühere Entscheidungen über ähnlichen Situationen (Situationen mit ähnlichen Eigenschaften) auch in Bezug nehmen kann. In jeder Runde berechnet sich jeder Agent den maximalen Gewinn, der er für diese Runde erwarten kann. Wenn die Runde fertig ist, merkt sich der Agent seine Entscheidungen (Bewerbung bei Abenteuern, Auswahl von Abenteuer bei Festlegungsphase usw.), vergleicht seinen tatsächlichen Gewinn mit dem maximalen erwarteten Gewinn und berechnet daraus einen Wert für seinen Bedauern. Wenn der Agent in der Zukunft mit einer ähnlichen Situation begegnet ist, kann er eine Koalition in Bezugnahme auf seinen früheren Entscheidungen und entsprechenden Bedauern auswählen, die seinen Bedauern für diese Runde minimiert. Um die optimale Entscheidung in einer gegebenen Situation zu treffen, muss der Agent diese oder ähnlichen Situationen mehrmals begegnet sein (nur so kann einen Agent gut lernen, welche Entscheidung seinen Bedauern minimiert). Daher muss das Lernen, wie auch früher gesagt nicht nur innerhalb eines Spiels, sondern über einen großen Anzahl an Spielen mit unterschiedlichen Bedingungen erfolgen.

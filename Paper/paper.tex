...
Ein konkreter Ansatz um Maschinelles Lernen in unseren Lösung einzubauen wäre Regret Minimization, der den Agenten ermöglicht aus dem Vergangenheit zu lernen um ihren Bedauern in der Zukunft zu minimieren. Jedoch, um Regret Minimization in unseren Implementierung einzubauen, müssen mehreren Änderungen in der Algorithmus vorgenommen werden. Anfangs muss die Nutzenfunktion so geändert werden, dass sie frühere Entscheidungen über ähnlichen Situationen auch in Bezug nehmen kann. In jede Runde berechnet sich jeder Agent ein maximalen Gewinn, der er für diese Runde erwarten kann. Wenn die Runde fertig ist, merkt sich der Agent seine Entscheidung, vergleicht seinen tatsächlichen Gewinn mit dem maximalen erwarteten Gewinn und berechnet daraus einen Wert für seinen Bedauern. Wenn der Agent in der Zukunft mit einer Situation mit ähnlichen Eigenschaften begegnet ist, kann er eine Koalition in Bezugnahme auf seinen früheren Entscheidungen und entsprechenden Bedauern auswählen, die seinen Bedauern für diese Runde minimiert. Um die optimale Entscheidung in eine gegebene Situation zu treffen, muss der Agent diese oder ähnlichen Situationen mehrmals begegnen (nur so kann einen Agent gut lernen, welche Entscheidung seinen Bedauern minimiert). Daher muss das Lernen, wie früher gesagt, nicht nur innerhalb einen Spiel, sondern über einen großen Anzahl an Spielen mit unterschiedlichen Bedingungen erfolgen.
